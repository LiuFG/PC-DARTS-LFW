...
def one_hot(x, num_classes, on_value=1., off_value=0., device='cuda'):
    ...
    # torch.full 填充off_value，
    # scatter_   把target中为1的地方换乘on_value
...
class FastCollateMixup:
    ...
    def __call__(self, batch):
        ...
        if self.mixup_enabled:
            lam = np.random.beta(self.mixup_alpha, self.mixup_alpha)  # beta分布，[0,1]，均值为0.5
        ...
        for i in range(batch_size):
            ...
            # tensor，与[batch_size - i - 1]，按lam权值mix
